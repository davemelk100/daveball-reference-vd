      ...
      <div className="flex flex-col gap-2">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            <h2 className={`uppercase tracking-wide font-semibold ${txt}`}>Daily Trivia</h2>
            {isComplete && (
              <Badge
                variant="secondary"
...
export function TriviaPanel() {
  return (
    <Suspense
      fallback={
        <div className="w-full bg-black/20 rounded-lg border border-white/20 p-4 h-[300px] animate-pulse" />
      }
    >
      <TriviaPanelContent />
    </Suspense>
